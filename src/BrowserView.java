...
public class BrowserView {
	...
	public BrowserView(BrowserModel model, String language) {
		...
		myErrorResource = ResourceBundle.getBundle(DEFAULT_RESOURCE_PACKAGE + "Error");
	...
	public void showPage(String url) {
		...
		try {
			...
			showError(String.format(myErrorResource.getString("showPageError"), url));
		}
	}
	...
	// public String makeDialogBox(String title, String prompt, String
	// defaultVal) {
	// TextInputDialog box = new TextInputDialog(defaultVal);
	// box.setTitle(title);
	// box.setHeaderText(prompt);
	// Optional<String> input = box.showAndWait();
	// if (input.isPresent()) {
	// return input.get();
	// }
	// return defaultVal;
